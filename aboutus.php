...
<body>
    ...
    <header>
        ...
        <section class="container1">
            <div class="container">
                <div class="image">
                    <img src="images/istockphoto-1347150429-612x612.jpg" alt="">
                </div>
                <div class="about" align="left">
                    <h1>ABOUT US</h1>
                    <p>At ELITE AUTOMOTIVE, we offer reliable car services to keep your vehicle in great shape. Our
                        experienced team handles everything from oil changes to repairs. We focus on honest, affordable
                        service and treat every car with care.</p>
                </div>
            </div>
        </section>
        <footer>
